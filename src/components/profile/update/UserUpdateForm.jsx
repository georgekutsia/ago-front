                ...
                <span className="p-float-label">
                  <Controller
                    ...
                    rules={{
                      ...
                      maxLength: {
                        value: 130,
                        message: "la url para la imágen debería ser mas corta",
                      },
                      minLength: {
                        value: 3,
                        message: "El nombre debe tener más de 3 caracteres",
                    ...
                    <Controller
                      ...
                      rules={{
                        ...
                        nim: {
                          value: 12,
                          message:
                            "Debe tener más de 12 años para usar nuestros servicios",
                        },
                      }}
                      render={({ field, fieldState }) => (
                        <InputText
                  ...
                  <span className="p-float-label">
                    <Controller
                      ...
                      rules={{
                        max: {
                          value: 30,
                          message: "Máximo números de teléfono de 30 digitos",
                        },
              ...
              <div className="field">
                <span className="p-float-label">
                  <MultiSelect
                    ...
                    value={typeSpecialization}
                    options={specializations}
                    onChange={handleTypeChange}
                    display="chip"
                    placeholder="Selecciona tipo de empresas que vas a crear. Máximo 3."
                    optionLabel="label"
                    optionValue="value"
                    maxSelectedLabels={3}
